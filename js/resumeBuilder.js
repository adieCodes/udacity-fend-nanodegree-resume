...
HTMLblog = HTMLblog.replace("%data%", bio.contactInfo.blog);
...
var HTMLskill1 = HTMLskills.replace("%data%", bio.skills[0]);
var HTMLskill2 = HTMLskills.replace("%data%", bio.skills[1]);
var HTMLskill3 = HTMLskills.replace("%data%", bio.skills[2]);
HTMLskills = HTMLskill1 + HTMLskill2 + HTMLskill3;
HTMLworkEmployer = HTMLworkEmployer.replace("%data%", work.employer);
HTMLworkTitle = HTMLworkTitle.replace("%data%", work.position);
HTMLworkDates = HTMLworkDates.replace("%data", work.years);
HTMLworkLocation = HTMLworkLocation.replace("%data%", work.location);
HTMLschoolName = HTMLschoolName.replace("%data%", education.name);
HTMLschoolDates = HTMLschoolDates.replace("%data%", education.years);
...
$("#workExperience").append(HTMLworkStart, HTMLworkTitle);
$("#education").append(HTMLschoolStart, HTMLschoolName);
